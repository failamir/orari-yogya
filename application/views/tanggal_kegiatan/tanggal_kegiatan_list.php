    ...
    <section class="content">
      ...
      <!-- Default box -->
        ...
        <div class="card-header">
		 <h5 class="card-title">Daftar tanggal_kegiatan </h5>	
		</div>
            <div class="card-body table-responsive">
            <div class="box-tools pull-right">            
                <?php echo anchor(site_url('tanggal_kegiatan/create'), '<i class = "fa fa-plus"></i> Tambah', 'class="btn btn-flat btn-info"'); ?>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#myTable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "tanggal_kegiatan/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "hari"},{"data": "tanggal"},{"data": "status"},
                        {
                            "data" : "action",
                            "orderable": false,
