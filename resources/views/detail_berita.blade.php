        ...
        <ul>
  		...
  		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?= url::to('/'); ?>/Berita/Lihat_Berita">Berita</a></li>
    ...
    <div class="col-12 info-panel">
      <div class="row">
        <div class="col-12" style="padding:0 0 0 0;;">
          <div class="jumbotron jumbotron-fluid" style="border-radius:12px;height:600px;background-image: url('@if($gambar == null){{ asset('storage/img_berita/default.png') }}@else{{ asset('storage/'. $gambar) }}@endif');background-repeat:no-repeat;background-position:center;background-size:85% 85%;">
            <div class="container">
      ...
      <div class="row">
        <div class="col-12" style="padding-bottom:10px;">
          <h2><?= $judul ?></h2>
          <p><?= 'Tanggal terbit : ' .$date ?></p>
          <span style="color:black;">
          <!-- <img src="{{ asset('storage/'. $gambar) }}" alt="gambar" width="400" height="400">  -->
          <?= $isi; ?>
          </span>
        </div>
      </div>
